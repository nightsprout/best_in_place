...
Gem::Specification.new do |s|
  ...
  s.test_files = ["spec/helpers/best_in_place_spec.rb", "spec/integration/double_init_spec.rb", "spec/integration/js_spec.rb", "spec/integration/live_spec.rb", "spec/integration/text_area_spec.rb", "spec/spec_helper.rb", "spec/support/retry_on_timeout.rb"]
